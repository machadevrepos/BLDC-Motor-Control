...
static const Power_Ip_PMC_ConfigType Power_Ip_PMC_ConfigPB =
{
    ...
    ,(
        ...
        PMC_AE_CONFIG_LVDVLSSEL_5_5V_U32 |
        PMC_AE_CONFIG_LINSUPSEL_VSUP_PIN_U32 |
        PMC_AE_CONFIG_VDDSEL5V_5V_U32
    )
    /* PMC_AE Configuration Register (CONFIG). This register only exist on M2xx series of devices */
    ,(
        PMC_AE_MONITOR_LVDVLSIE_ENABLE_U32 |
        PMC_AE_MONITOR_LVDCIE_DISABLE_U32 |
        PMC_AE_MONITOR_HVDVDDIE_ENABLE_U32 |
        PMC_AE_MONITOR_HVDINT15IE_ENABLE_U32
    )
};
...
static const Power_Ip_AEC_ConfigType Power_Ip_AEC_ConfigPB =
{
    (
        ...
        AEC_AE_RSTGEN_CFG_GDU_ENABLE_U16 |
        AEC_AE_RSTGEN_CFG_HVI_DISABLE_U16 |
        AEC_AE_RSTGEN_CFG_DPGA_ENABLE_U16 |
