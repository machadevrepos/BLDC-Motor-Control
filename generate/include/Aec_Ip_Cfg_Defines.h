...
#define AEC_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION      9
#define AEC_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION   0
#define AEC_IP_CFG_DEFINES_SW_MAJOR_VERSION              7
