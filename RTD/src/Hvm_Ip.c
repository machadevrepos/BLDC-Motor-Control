...
#if(defined(HVM_IP_YOUNG_FELLOW) && (STD_OFF == HVM_IP_YOUNG_FELLOW))
...
#define HVM_IP_AR_RELEASE_MINOR_VERSION_C       9
#define HVM_IP_AR_RELEASE_REVISION_VERSION_C    0
#define HVM_IP_SW_MAJOR_VERSION_C               7
...
/*!
 * @brief Checks if the status flag has raised.
 *
 * @param[in] MaksVal    The mask value of register
 * @param[in] Timeout    The accumulated elapsed time from the starting time reference
...
/*!
 * @brief Report event raised interrupt.
 *
 * @param[in] Instance    The instance of Hvm
 * @param[in] Event       The event type report
 * @return Status of transmission
 */
...
/*!
 * @brief Initializes for HVI channels.
 *
...
/*!
 * @brief Initializes for Analog Input configuration.
 *
 ...
 * @param[in] ConfigAgain reconfigure or not
 * @return Status of transmission
 */
...
/*!
 * @brief Initializes for Voltage Monitor configuration.
 *
...
Hvm_Ip_StatusType  Hvm_Ip_Init(const Hvm_Ip_ConfigType *pHvmConfig)
{
    ...
    HVM_DEV_ASSERT((boolean)(pHvmConfig != NULL_PTR));
                                           ...
                                           )
{
    ...
    HVM_DEV_ASSERT((boolean)(pHviHighVoltConfig != NULL_PTR));
...
Hvm_Ip_StatusType  Hvm_Ip_DigitalInputEventConfig(const Ae_HviChannelConfig *pHviConfig)
{
    ...
    HVM_DEV_ASSERT((boolean)(pHviConfig != NULL_PTR));
                                               ...
                                               )
{
    ...
    HVM_DEV_ASSERT((boolean)(pAeVmConfig           != NULL_PTR));
    HVM_DEV_ASSERT((boolean)(pHighVoltageInput     != NULL_PTR));
