...
#define GDU_IP_IRQ_AR_RELEASE_MINOR_VERSION_C       9
#define GDU_IP_IRQ_AR_RELEASE_REVISION_VERSION_C    0
#define GDU_IP_IRQ_SW_MAJOR_VERSION_C               7
...
==================================================================================================*/
    ...
    #if (GDU_IP_IRQ_VENDOR_ID_C != AEC_IP_TYPES_VENDOR_ID)
        #error "Gdu_Ip_Irq.c and Aec_Ip.h have different vendor ids"
    #endif
    #if ((GDU_IP_IRQ_AR_RELEASE_MAJOR_VERSION_C    != AEC_IP_AR_RELEASE_MAJOR_VERSION) || \
         (GDU_IP_IRQ_AR_RELEASE_MINOR_VERSION_C    != AEC_IP_AR_RELEASE_MINOR_VERSION) || \
         (GDU_IP_IRQ_AR_RELEASE_REVISION_VERSION_C != AEC_IP_AR_RELEASE_REVISION_VERSION))
        #error "AutoSar Version Numbers of Gdu_Ip_Irq.c and Aec_Ip.h are different"
    #endif
    #if ((GDU_IP_IRQ_SW_MAJOR_VERSION_C != AEC_IP_SW_MAJOR_VERSION) || \
         (GDU_IP_IRQ_SW_MINOR_VERSION_C != AEC_IP_SW_MINOR_VERSION) || \
         (GDU_IP_IRQ_SW_PATCH_VERSION_C != AEC_IP_SW_PATCH_VERSION))
        #error "Software Version Numbers of Gdu_Ip_Irq.c and Aec_Ip.h are different"
    #endif
#endif
