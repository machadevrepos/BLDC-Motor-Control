...
#define PWMC_LS_PIN             11u
#define PWMC_LS_PORT            PTC_L_HALF
#define PWMC_HS_PIN             10u
#define PWMC_HS_PORT            PTC_L_HALF
#define PWMA_LS_PIN             3u
#define PWMA_LS_PORT            PTA_L_HALF
#define PWMA_HS_PIN             2u
#define PWMA_HS_PORT            PTA_L_HALF
#define PWMB_LS_PIN             11u
#define PWMB_LS_PORT            PTB_L_HALF
#define PWMB_HS_PIN             10u
#define PWMB_HS_PORT            PTB_L_HALF
#define DCB_V_PIN               6u
#define DCB_V_PORT              PTA_L_HALF
#define DCB_I_PIN               13u
#define DCB_I_PORT              PTB_L_HALF
#define AE_CS_PIN               1u
#define AE_CS_PORT              PTB_H_HALF
#define AE_SIN_PIN              15u
#define AE_SIN_PORT             PTB_L_HALF
#define AE_CLK_PIN              14u
#define AE_CLK_PORT             PTB_L_HALF
#define AE_SOUT_PIN             0u
#define AE_SOUT_PORT            PTB_H_HALF
#define FMSTR_RX_PIN            2u
#define FMSTR_RX_PORT           PTC_L_HALF
#define FMSTR_TX_PIN            3u
#define FMSTR_TX_PORT           PTC_L_HALF
#define TST_TGMX_O6_PIN         15u
#define TST_TGMX_O6_PORT        PTE_L_HALF
#define TST_TGMX_O7_PIN         0u
#define TST_TGMX_O7_PORT        PTE_H_HALF
#define ENC_PHA_PIN             1u
#define ENC_PHA_PORT            PTD_L_HALF
#define ENC_PHB_PIN             11u
#define ENC_PHB_PORT            PTE_L_HALF
#define RESET_B_PIN             5u
#define RESET_B_PORT            PTA_L_HALF
#define AE_INT_PIN              3u
#define AE_INT_PORT             PTD_L_HALF
#define TST_GPIO_D16_PIN        0u
#define TST_GPIO_D16_PORT       PTD_H_HALF
#define BTN_INC_SW0_PIN         15u
#define BTN_INC_SW0_PORT        PTA_L_HALF
#define BTN_DEC_SW1_PIN         0u
#define BTN_DEC_SW1_PORT        PTD_L_HALF
#define LED_PIN                 15u
#define LED_PORT                PTD_L_HALF
